                    ...
                    public void onClick(View view) {
                        ...
                        findViewById(R.id.proof_view_button_continue).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                              ...
                              //  DatabaseReference mDatabaseRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Citizens").child(userId).child("potholeReports").child(timeKey);
...
//                                userMap.put("Civil Agent Comment",comment_textView.getText().toString());
